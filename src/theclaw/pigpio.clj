...
(defn send-range [pwm dir sleep & [d]]
  ...
  (send-pigpio :setpwmfrequency pwm 100)
  (Thread/sleep 100)
  (send-pigpio :setpwmfrequency pwm 200)
  (Thread/sleep 100)
  (send-pigpio :setpwmfrequency pwm 300)
  (Thread/sleep 100)
  #_(send-pigpio :setpwmfrequency pwm 320)
  (Thread/sleep 2000)
  (send-pigpio :setpwmfrequency pwm 0)
  #_(send-pigpio :setpwmfrequency pwm 1100)
  #_(Thread/sleep 100)
  #_(doseq [x (reverse (range 4))]
    (println (* x 200))
    (Thread/sleep 100)
    (send-pigpio :setpwmfrequency pwm (* x 100)))
